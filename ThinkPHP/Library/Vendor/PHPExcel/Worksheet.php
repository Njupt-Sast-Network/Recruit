...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
	...
	*/
	...
	private static function _checkSheetTitle($pValue)
	{
		...
		// Maximum 61 characters allowed for sheet title
		if (PHPExcel_Shared_String::CountCharacters($pValue) > 61) {
			throw new Exception('Maximum 61 characters allowed in sheet title.');
		}//原来是31个字符
